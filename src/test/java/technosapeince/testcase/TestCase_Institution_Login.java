...
public class TestCase_Institution_Login extends BaseTest {
    ...
    public void testCase_1(HashMap<String, String> data) throws Exception { // Valid Login
        ...
        LoginPage loginpage = select.asInstitute();
    ...
    public Object[][] getData() throws IOException {
        List<HashMap<String, String>> data = getJsonDataToMap(
                System.getProperty("user.dir") + "\\src\\test\\java\\technosapeince\\data\\InstituteData.json");
